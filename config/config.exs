...
config :ex_cldr, default_backend: AshPay.Cldr
...
config :ash_pay, AshPayWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AshPayWeb.ErrorHTML, json: AshPayWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: AshPay.PubSub,
  live_view: [signing_salt: "4HXAHjhl"]
...
config :ash_pay, AshPay.Mailer, adapter: Swoosh.Adapters.Local
